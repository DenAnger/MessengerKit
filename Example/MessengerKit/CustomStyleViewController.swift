...
class CustomStyleViewController: MSGMessengerViewController {
    ...
    lazy var messages: [[MSGMessage]] = {
        return [
            ...
            [MSGMessage(id: 4,
                        ...
                        user: tim,
                        sentAt: Date())],
            [MSGMessage(id: 5, body: .text("Ugh, gotta sit through these two…"),
                        user: steve,
                        sentAt: Date())],
            [MSGMessage(id: 6, body: .image(#imageLiteral(resourceName: "Splatoon")),
                        user: steve,
                        sentAt: Date())],
            [MSGMessage(id: 7,
    ...
    override func viewDidLoad() {
        ...
        title = "Custom"
        tintColor = UIColor(hue:0.90,
                            saturation:0.70,
                            brightness:0.85,
                            alpha:1.00)
        navigationController?.navigationBar.barStyle = .black
        navigationController?.navigationBar.tintColor = UIColor(hue:0.90,
                                                                saturation:0.70,
                                                                brightness:0.85,
                                                                alpha:1.00)
        dataSource = self
